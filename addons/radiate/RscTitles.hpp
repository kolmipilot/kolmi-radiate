...
class RscTitles
{
    class KOLMIR_ChemicalDetector
    {
        ...
        fadeOut=1;
        duration = 10e10;
        onLoad = "uiNamespace setVariable ['KOLMIR_ChemicalDetector', _this select 0];";
        class controls
        {   
